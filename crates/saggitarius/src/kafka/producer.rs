...
use rdkafka::{error::KafkaError, producer::{FutureProducer, Producer}, util::Timeout, ClientConfig};

use crate::conf::config_types::KafkaConfiguration;

pub fn init_producer(config: &KafkaConfiguration) -> Result<FutureProducer, KafkaError> {
